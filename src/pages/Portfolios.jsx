            ...
            <aside className="flex flex-wrap justify-center gap-4 p-6">
              <div className="group relative">
                <button className='
                  ...
                  active:scale-95
                '>
                  <Link to="/brianm/digital-marketing" className="flex flex-col items-center justify-center h-full">
                    <img 
              ...
              <div className="group relative">
                <button className='bg-[#D3A522]! rounded-2xl p-4 w-40 h-40 max-sm:w-full max-sm:h-auto max-sm:py-3 transition-all duration-300 ease-out transform hover:scale-105 hover:bg-amber-700! hover:shadow-lg active:scale-95'>
                  <Link to="/brianm/graphic-designing" className="flex flex-col items-center justify-center h-full">
                    <img 
              ...
              <div className="group relative">
                <button className='bg-[#D3A522]! rounded-2xl p-4 w-40 h-40 max-sm:w-full max-sm:h-auto max-sm:py-3 transition-all duration-300 ease-out transform hover:scale-105 hover:bg-amber-700! hover:shadow-lg active:scale-95'>
                  <Link to="/brianm/web-development" className="flex flex-col items-center justify-center h-full">
                    <img 
              ...
              <div className="group relative">
                <button className='bg-[#D3A522]! rounded-2xl p-4 w-40 h-40 max-sm:w-full max-sm:h-auto max-sm:py-3 transition-all duration-300 ease-out transform hover:scale-105 hover:bg-amber-700! hover:shadow-lg active:scale-95'>
                  <Link to="/brianm/seo" className="flex flex-col items-center justify-center h-full">
                    <img 
