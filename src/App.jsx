...
function App() {
  ...
  //           width={200} 
  //           height={100}  
  //           className='max-sm:absolute max-sm:w-[5rem] max-sm:top-7'
  //         />
  //       </figure>
  ...
  //           <div>
  //             <ul className='text-sm text-blue-700'>
  //               <li className="hover:underline"><Link to="digital-marketing">Digital Marketing</Link></li>
  //               <li className="hover:underline"><Link to="graphic-designing">Graphic Designing</Link></li>
  //               <li className="hover:underline"><Link to="web-development">Web Development</Link></li>
  //               <li className="hover:underline"><Link to="seo">SEO Optimization</Link></li>
  //             </ul>
  ...
  //       <aside className='absolute bottom-0 flex left-1/2 text-xs max-sm:left-15'>
  ...
  <Route path="/cv-qualifications" element={<Qualifications />} />
  <Route path="/contact" element={<ContactMe />} />
  <Route path="/brianm/digital-marketing" element={<DigitalMarketing />} />
  <Route path="/brianm/graphic-designing" element={<GraphicDesigning />} />
  <Route path="/brianm/web-development" element={<WebDevelopment />} />
  <Route path="/brianm/seo" element={<SeoOptimiztion />} />
  <Route path="/test" element={<Test />} />
  <Route path="*" element={<LandingPage />} />
</Routes>
